...
public class StarBar extends View {
     ...
     * 设置评分图标
     */
    public void setStarFillBitmap(int dr) {
        this.starFillBitmap = drawableToBitmap(getResources().getDrawable(dr));
        invalidate();
    }
