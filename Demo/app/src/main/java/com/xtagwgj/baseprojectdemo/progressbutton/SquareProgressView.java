...
public class SquareProgressView extends View {
    ...
    private void initializePaints(Context context) {
        ...
        progressBarPaint.setStrokeWidth(MeasureUtil.dp2px(getContext(), widthInDp));
    ...
    protected void onDraw(Canvas canvas) {
        this.canvas = canvas;
        super.onDraw(canvas);
        strokewidth = MeasureUtil.dp2px(getContext(), widthInDp);
    ...
    public void setWidthInDp(int width) {
        ...
        progressBarPaint.setStrokeWidth(MeasureUtil.dp2px(
                getContext(), widthInDp));
        this.invalidate();
    }
