...
public class ButtonM extends Button {
    ...
    private String backColors = "#1A1D24";//背景色，String类型
    private int backColori = 0;//背景色，int类型
    private String backColorSelecteds = "#0093ED";//按下后的背景色，String类型
    ...
    private String textColors = "#787A7F";//文字颜色，String类型
    private int textColori = 0;//文字颜色，int类型
    private String textColorSeleteds = "#FFFFFF";//按下后的文字颜色，String类型
